...
const Hero = ()=>{
    return(
        ...
        <img className='w-auto h-8/10 absolute right-20 z-10 bottom-0 max-sm:bottom-[60px] max-[820px]:bottom-[100px] max-[820px]:w-[65%] max-[820px]:right-0 max-sm:w-[500px] max-sm:right-[-10%]' src="/images/doctor.png" alt="Doctor" />
